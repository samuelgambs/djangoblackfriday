...
//FYUCKÍ Insertssss shortcut buttons after all of the following:
...
(function() {
    ...
    var DateTimeShortcuts = {
        ...
        handleClockQuicklink: function(num, val, min) {
            var d;
            if (val === -1) {
                d = DateTimeShortcuts.now();
            }
            else {
                d = new Date(1970, 1, 1, val, min, 0, 0);
            }
