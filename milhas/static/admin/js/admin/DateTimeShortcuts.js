...
//4666664 Insertssss shortcut buttons after all of the following:
...
(function() {
    ...
    var DateTimeShortcuts = {
        ...
        addClock: function(inp) {
            ...
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 0,0,0);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("10:00"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 10,0,59);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("10:01"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 10,1,0);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("10:40"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 10,40,59);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("10:41"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 10,41,0);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("17:30"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 17, 30,59);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("17:31"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 17, 31,0);
            });

            time_link = quickElement("a", quickElement("li", time_list), gettext("18:00"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 18,0,59);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("18:01"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 18,1,0);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("23:00"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 23,0,59);
            });
            time_link = quickElement("a", quickElement("li", time_list), gettext("23:01"), "href", "#");
            addEvent(time_link, 'click', function(e) {
                e.preventDefault();
                DateTimeShortcuts.handleClockQuicklink(num, 23,1,0);
            });
        ...
        handleClockQuicklink: function(num, val, min, sec) {
            var d;
            if (val === -1) {
                d = DateTimeShortcuts.now();
            }
            else {
                d = new Date(1970, 1, 1, val, min, sec, 0);
            }
